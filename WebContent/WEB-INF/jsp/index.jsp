...
<link href="B-JUI/BJUI/themes/css/FA/css/font-awesome.css" rel="stylesheet">
<!--[if lte IE 7]>
...
<!-- HighCharts -->
<script src="B-JUI/BJUI/plugins/highcharts/highcharts.js"></script>
<script src="B-JUI/BJUI/plugins/highcharts/highcharts-3d.js"></script>
<script src="B-JUI/BJUI/plugins/highcharts/themes/gray.js"></script>
<!-- ECharts -->
<script src="B-JUI/BJUI/plugins/echarts/echarts.js"></script>
<!-- other plugins -->
<script src="B-JUI/BJUI/plugins/other/jquery.autosize.js"></script>
<link href="B-JUI/BJUI/plugins/uploadify/css/uploadify.css" rel="stylesheet">
<script src="B-JUI/BJUI/plugins/uploadify/scripts/jquery.uploadify.min.js"></script>
<script src="B-JUI/BJUI/plugins/download/jquery.fileDownload.js"></script>
<!-- init -->
...
<script type="text/javascript">
$(function(){
    SyntaxHighlighter.config.clipboardSwf = 'B-JUI/js/syntaxhighlighter-2.1.382/scripts/clipboard.swf'
...
<li ><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-check-square-o"></i>系统管理</a>
    <div class="items hide" data-noinit="true">
        <ul id="bjui-hnav-tree1" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="check-square-o">
            ...
            <li data-id="110" data-pid="11" data-url="B-JUI/form-button.html" data-tabid="form-button" data-faicon="hand-o-up">按钮</li>
            <li data-id="111" data-pid="11" data-url="B-JUI/form-input.html" data-tabid="form-input" data-faicon="terminal">文本框</li>
            <li data-id="112" data-pid="11" data-url="B-JUI/form-select.html" data-tabid="form-select" data-faicon="caret-square-o-down">下拉选择框</li>
            ...
            <li data-id="126" data-pid="12" data-url="role/list" data-tabid="rolelist" data-faicon="list-alt">角色管理</li>
            <li data-id="127" data-pid="12" data-url="menu/list" data-tabid="table-edit" data-faicon="indent">菜单管理</li>
        	<li data-id="128" data-pid="12" data-url="user/userinfo" data-tabid="datagrid-demo" data-faicon="list-alt">用户管理</li>
        </ul>
        <ul id="bjui-doc-tree-techi" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="th" data-tit="技工管理">	
        	<li data-id="13" data-pid="0" data-faicon="folder-open-o" data-faicon-close="folder-o">技工管理</li>
        	<li data-id="130" data-pid="13" data-url="technician/list" data-tabid="technicianlist" data-faicon="list">技工管理</li>
        </ul>
    </div>
</li>
                    ...
                    <li ><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-check-square-o"></i> 表单元素</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree1" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="check-square-o">
                                ...
                                <li data-id="10" data-pid="1" data-url="B-JUI/form-button.html" data-tabid="form-button" data-faicon="hand-o-up">按钮</li>
                                <li data-id="11" data-pid="1" data-url="B-JUI/form-input.html" data-tabid="form-input" data-faicon="terminal">文本框</li>
                                <li data-id="12" data-pid="1" data-url="B-JUI/form-select.html" data-tabid="form-select" data-faicon="caret-square-o-down">下拉选择框</li>
                                <li data-id="13" data-pid="1" data-url="B-JUI/form-checkbox.html" data-tabid="table" data-faicon="check-square-o">复选、单选框</li>
                                <li data-id="14" data-pid="1" data-url="B-JUI/form.html" data-tabid="form" data-faicon="list">表单综合演示</li>
                                <li data-id="15" data-pid="1" data-url="technician/list" data-tabid="form" data-faicon="list">技工管理</li>
                                <li data-id="15" data-pid="1" data-url="editor/add.jsp" data-tabid="form" data-faicon="list">在线编辑器</li>
                                <li data-id="15" data-pid="1" data-url="editor/add.jsp" data-tabid="form" data-faicon="list" style="visibility:hidden;">在线编辑器111111</li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-table"></i> 表格</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree2" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="table">
                                ...
                                <li data-id="20" data-pid="2" data-url="B-JUI/table.html" data-tabid="table" data-faicon="table">普通表格</li>
                                <li data-id="21" data-pid="2" data-url="B-JUI/table-fixed.html" data-tabid="table-fixed" data-faicon="list-alt">固定表头表格</li>
                                <li data-id="21" data-pid="2" data-url="role/list" data-tabid="table-fixed" data-faicon="list-alt">角色管理</li>
                                <li data-id="22" data-pid="2" data-url="B-JUI/table-edit.html" data-tabid="table-edit" data-faicon="indent">可编辑表格</li>
                                <li data-id="24" data-pid="2" data-url="menu/list" data-tabid="table-edit" data-faicon="indent">菜单管理</li>
                                <li data-id="23" data-pid="2" data-url="user/userinfo" data-tabid="datagrid-demo" data-faicon="list-alt">用户管理</li>
                            </ul>
                        </div>
                    </li>
                    <li><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-table"></i> Datagrid(beta)</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree-datagrid" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="table">
                                ...
                                <li data-id="31" data-pid="3" data-url="B-JUI/datagrid-convertable.html" data-tabid="datagrid-convertable" data-faicon="table">转换普通表格</li>
                                <li data-id="32" data-pid="3" data-url="B-JUI/datagrid-demo.html" data-tabid="datagrid-demo" data-faicon="table">完整示例</li>
                                <li data-id="32" data-pid="3" data-url="user/list" data-tabid="datagrid-demo" data-faicon="table">用户管理</li>
                                <li data-id="33" data-pid="3" data-url="B-JUI/datagrid-datatype.html" data-tabid="datagrid-datatype" data-faicon="table">三种数据类型</li>
                            </ul>
                        </div>
                    </li>
                    <li><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-plane"></i> 弹出窗口</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree4" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="plane">
                                ...
                                <li data-id="40" data-pid="4" data-url="B-JUI/dialog.html" data-tabid="dialog" data-faicon="plane">弹出窗口</li>
                                <li data-id="41" data-pid="4" data-url="B-JUI/alert.html" data-tabid="alert" data-faicon="info-circle">信息提示</li>
                            </ul>
                        </div>
                    </li>
                    <li><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-image"></i> 图形报表</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree5" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="image">
                                ...
                                <li data-id="51" data-pid="5" data-url="B-JUI/highcharts.html" data-tabid="chart" data-faicon="image">Highcharts图表</li>
                                <li data-id="52" data-pid="5" data-url="B-JUI/echarts.html" data-tabid="echarts" data-faicon="image">ECharts图表</li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cog"></i> 系统设置 <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="technician/list">角色权限</a></li>
                            <li><a href="#">用户列表</a></li>
                            <li class="divider"></li>
                            <li><a href="#">关于我们</a></li>
                            <li class="divider"></li>
            ...
            <div class="tabsPageHeader">
                <div class="tabsPageHeaderContent">
                    <ul class="navtab-tab nav nav-tabs">
                    	<!-- 首页 -->
                        <li data-url="B-JUI/index_layout.html"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
                    </ul>
                </div>
