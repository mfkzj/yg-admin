 ...
 */
 public class CompressPic { 
	...
	public String compressPic() { 
 	...
 	/**
 	 * 图片压缩
 	 * @param inputDir 图片输入路径
 	 * @param outputDir 图片输出路径
 	 * @param inputFileName 输入图片名称
 	...
 	public static void main(String[] arg) { 
 		...
 		System.out.println("输入的图片大小：" + mypic.getPicSize("e:\\new\\1111.jpg")/1024 + "KB"); 
 		mypic.compressPic("e:\\new\\", "e:\\new\\", "1111.jpg", "r1.jpg", 120, 120, true); 
 		int count = 0; // 记录全部图片压缩所用时间
// 		for (int i = 0; i < 100; i++) { 
// 			int start = (int) System.currentTimeMillis();	// 开始时间 
// 			mypic.compressPic("e:\\new\\", "e:\\new\\", "1.jpg", "r1"+i+".jpg", 120, 120, true); 
